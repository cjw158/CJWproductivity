...
export const DynamicIsland = memo(function DynamicIsland() {
  ...
  }, [captureText, noteMode, latestNoteTitle]);
        ...
        {isCaptureMode ? (
          ...
          >
            {activeTasks.length > 0 ? (
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, opacity: 0.8 }}>
                <span style={{ color: colors.textMuted, fontSize: 12 }}>即将开始:</span>
                <span style={{ 
                    color: colors.text, 
                    fontSize: 13, 
                    fontWeight: 600,
              ...
              <span style={{ color: colors.textMuted, fontSize: 14, fontWeight: 400 }}>暂无进行中任务</span>
            )}
          </motion.div>
        ) : (
          // 展开状态 - 今日任务列表
          ...
          >
            ...
            <div style={{ 
              ...
              <span style={{ color: colors.text, fontSize: 15, fontWeight: 700, letterSpacing: "-0.3px" }}>今日任务</span>
              <span style={{ 
                color: colors.accent, 
                fontSize: 13, 
                fontWeight: 600,
